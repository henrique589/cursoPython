...
# de uma mesma superclasse tenham métodos iguais (com a mesma assinatura)
...
# SO"L"ID
# Princípio da substituição da liskov
# Objetos de uma superclasse devem ser subtituíveis
